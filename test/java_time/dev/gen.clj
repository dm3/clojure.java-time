    ...
    (concat
      [";; NOTE: This namespace is generated by java-time.dev.gen"
       `(~'ns ~'java-time
          ...
          (:require java-time.clock java-time.util ;;macros
                    ;;runtime
                    java-time.core java-time.adjuster java-time.amount java-time.chrono java-time.clock
                    ...
                    ;;FIXME don't compile in :bb (can't insert reader conditional from here)
                    java-time.mock))]
