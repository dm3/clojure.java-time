...
(deftest ordering
  ...
  (testing "times"
    ...
    (let [dt (j/local-time clock)
          dt+5 (j/plus dt (j/minutes 5))]
      (is (j/after? dt+5 dt))
      (is (not (j/after? dt dt+5)))
      (is (j/before? dt dt+5))
      (is (not (j/before? dt+5 dt)))
    ...
    (let [dt (j/zoned-date-time clock)
          dt+5 (j/plus dt (j/minutes 5))]
      (is (j/after? dt+5 dt))
      (is (not (j/after? dt dt+5)))
      (is (j/before? dt dt+5))
    ...
    (let [dt (j/offset-date-time clock)
          dt+5 (j/plus dt (j/minutes 5))]
      (is (j/after? dt+5 dt))
      (is (not (j/after? dt dt+5)))
      (is (j/before? dt dt+5))
